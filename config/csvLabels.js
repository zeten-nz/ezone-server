...
const LABELS = {
  uz: {
    columns: {
      ...
      // Warranty CSV export — full detail-view parity
      warrantyStatus: 'Kafolat holati',
      installerFullName: "O'rnatuvchi F.I.Sh.", installerPhone: "O'rnatuvchi telefoni",
      region: 'Viloyat', city: 'Shahar', district: 'Tuman',
      branchName: 'Filial/tashkilot', branchCode: 'Filial kodi', orgPhone: 'Tashkilot telefoni',
      productionYear: 'Ishlab chiqarilgan yili', mileage: 'Probeg',
      reducerProduct: 'Redyuktor (mahsulot)', reducerSerial: 'Redyuktor seriya raqami',
      cylinderProduct: 'Tsilindr (mahsulot)', cylinderSerial: 'Tsilindr seriya raqami',
      controllerProduct: 'Kontroller (mahsulot)', controllerSerial: 'Kontroller seriya raqami',
      injectorRailProduct: 'Injektor relsi (mahsulot)', injectorRailSerial: 'Injektor relsi seriya raqami',
      easyGasSyncResult: 'EasyGas sinxronizatsiyasi', easyGasClaimUrl: 'EasyGas havolasi',
      reviewedAt: "Ko'rib chiqilgan sana", reviewNotes: "Ko'rib chiqish izohi", reviewedBy: "Ko'rib chiquvchi",
    ...
    warrantyStatuses: { PENDING: 'Kutilmoqda', SUCCESSFUL: 'Tasdiqlangan', REJECTED: 'Rad etilgan' },
    easyGasSyncResults: { PENDING: 'Kutilmoqda', SUCCESS: 'Muvaffaqiyatli', FAILED: 'Xatolik' },
    transactionTypes: {
  ...
  ru: {
    columns: {
      ...
      installerFullName: 'ФИО установщика', installerPhone: 'Телефон установщика',
      region: 'Область', city: 'Город', district: 'Район',
      branchName: 'Филиал/организация', branchCode: 'Код филиала', orgPhone: 'Телефон организации',
      productionYear: 'Год выпуска', mileage: 'Пробег',
      reducerProduct: 'Редуктор (продукт)', reducerSerial: 'Серийный номер редуктора',
      cylinderProduct: 'Цилиндр (продукт)', cylinderSerial: 'Серийный номер цилиндра',
      controllerProduct: 'Контроллер (продукт)', controllerSerial: 'Серийный номер контроллера',
      injectorRailProduct: 'Инжекторная рейка (продукт)', injectorRailSerial: 'Серийный номер инжекторной рейки',
      easyGasSyncResult: 'Синхронизация EasyGas', easyGasClaimUrl: 'Ссылка EasyGas',
      reviewedAt: 'Дата проверки', reviewNotes: 'Комментарий проверки', reviewedBy: 'Проверил',
    ...
    fuelTypes: { LPG: 'LPG', CNG: 'CNG' },
    warrantyStatuses: { PENDING: 'В ожидании', SUCCESSFUL: 'Одобрено', REJECTED: 'Отклонено' },
    easyGasSyncResults: { PENDING: 'В ожидании', SUCCESS: 'Успешно', FAILED: 'Ошибка' },
    transactionTypes: {
